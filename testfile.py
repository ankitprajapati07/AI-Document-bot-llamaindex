...
def load_data():
    with st.spinner(text="Loading and indexing your file – hang tight! This should take 1-2 minutes."):
        ...
        service_context = ServiceContext.from_defaults(llm=OpenAI(model="gpt-3.5-turbo", temperature=0.5, system_prompt="You are an AI with the ability to understand and generate responses based on the content of an uploaded file. The file can contain any type of text information. Your job is to answer questions about the content of the file. – do not hallucinate features."))
